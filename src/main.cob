...
*> *      *>*****************************************************************
       7510-SEARCH-FOR-USER.
           ...
           MOVE SPACES TO WS-SEARCH-REMAINDER.
           ...
           IF FUNCTION TRIM(WS-SEARCH-FIRST-NAME) = SPACES
               OR FUNCTION TRIM(WS-SEARCH-LAST-NAME) = SPACES
               OR FUNCTION TRIM(WS-SEARCH-REMAINDER) NOT = SPACES
               EXIT PARAGRAPH
           END-IF.
           PERFORM VARYING WS-ACCOUNT-INDEX FROM 1 BY 1
               UNTIL WS-ACCOUNT-INDEX > WS-PROFILE-COUNT
