...
# CONNECTIONS.DAT: CONN-USER-A (20) + CONN-USER-B (20)
CONNECTION_USERNAME_WIDTH: Final[int] = 20

# MESSAGES.DAT record (matches main.cob FD MESSAGES-FILE)
MESSAGE_ID_WIDTH: Final[int] = 5
MESSAGE_USERNAME_WIDTH: Final[int] = 20
MESSAGE_CONTENT_WIDTH: Final[int] = 200
MESSAGE_TIMESTAMP_WIDTH: Final[int] = 20
MESSAGE_RECORD_WIDTH: Final[int] = (
    MESSAGE_ID_WIDTH
    + MESSAGE_USERNAME_WIDTH * 2
